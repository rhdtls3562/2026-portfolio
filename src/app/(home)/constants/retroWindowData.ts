...
export const README_SECTIONS: ReadmeSection[] = [
  {
    title: "Who Am I?",
    paragraphs: [
      "8살 때 미술 대회 대상을 받은 뒤 '보기 좋게 만드는 일'에 꾸준히 몰입해왔습니다. 한국전통문화고등학교를 졸업한 뒤 뉴질랜드 Cut above academy에서 디지털 디자인을 공부하며 색채와 조형, 툴 활용 역량을 키웠습니다.",
  ...
  },
  {
    title: "What I Do?",
    paragraphs: [
      "약 5년 6개월 동안 패션, 뷰티, 의료, 반려동물 분야를 거치며 웹디자인, 웹퍼블리싱, 웹서비스 기획을 함께 담당했습니다. 현재는 쉐브론에서 아모레퍼시픽 BTS, 챗봇, 립 AR, 두피 진단 서비스의 웹퍼블리싱과 웹디자인을 맡고 있습니다.",
  ...
  },
  {
    title: "How I Work?",
    paragraphs: [
      "코드잇 프론트엔드 부트캠프 6개월 동안 두 번의 팀 프로젝트에서 모두 팀장을 맡아 기획부터 배포까지 전체 흐름을 이끌었습니다. 완성도, UI 디테일, 코드 구조까지 끝까지 챙기는 방식으로 일합니다.",
